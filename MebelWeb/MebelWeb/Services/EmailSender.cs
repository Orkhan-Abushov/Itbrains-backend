...
namespace MebelWeb.Services
{
    ...
    public class EmailSender : IEmailService
    {
        ...
        public async Task SendEmailAsync(string to, string subject, string message)
        {
            ...
            var mimeMessage = new MimeMessage();
            mimeMessage.From.Add(new MailboxAddress("Orxan", "orxanabusov326@gmail.com"));
            mimeMessage.To.Add(MailboxAddress.Parse(to));
            mimeMessage.Subject = "subject";
            ...
            await client.AuthenticateAsync("orxanabusov326@gmail.com", "rjde ddfi espi chpb");
            await client.SendAsync(mimeMessage);
            await client.DisconnectAsync(true);
            var msg = new MimeMessage();
            var mailFrom = new MailboxAddress("Admin", "orxanabusov326@gmail.com");
            var mailTo = new MailboxAddress("User", to);
            //}
            //catch (Exception ex)
            //{
